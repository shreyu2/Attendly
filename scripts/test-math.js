import { calculateAttendancePercentage, calculateSafeSkips, calculateRecoveryNeeded, computeSubjectStats, computeOverallStats, evaluateCanSkipTomorrow, } from '../src/lib/attendanceCalculator';
console.log('====================================================');
...
const subA = { id: 'a', user_id: 'u', name: 'Sub A', code: 'A', target_percentage: null };
const subB = { id: 'b', user_id: 'u', name: 'Sub B', code: 'B', target_percentage: null };
const multiRecords = [
...
const subCustom = { id: 'c', user_id: 'u', name: 'Sub C', code: 'C', target_percentage: 90 };
